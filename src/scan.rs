...
/// true. The root paths themselves (depth 0 of the walk) are always skipped -
/// `ren` only renames things *inside* the directories it was pointed at.
///
...
pub(crate) fn walk_paths(
    ...
    for dir in dirs {
        ...
        for result in builder.build() {
            ...
            // Skip the root itself (depth 0 of this walk). `ren` does not
            // rename directories it was asked to walk into.
            if dirent.depth() == 0 {
                continue;
            }
